...
const Phone = ({ navigation }: AuthNavigationProps<"Email">): JSX.Element => {
  ...
  return (
    ...
    <Box alignItems="center" >
      <Center mt={71} maxWidth={375} w="90%">
        ...
        <Center mt={50}>
          ...
          {user.phone ? (<InputGroup w={{
            ...
            <InputLeftAddon height={66} borderWidth={0}
              children={<Text borderRightWidth={1}
                borderColor="#ECECEC"
                color="#393939C2"
                fontSize={16}
                paddingRight={10}>
        ...
        <Center flexDir={"row"} mt={50}>
          <Button text='Reset Password'
            callback={() => navigation.navigate("ResetPin")}
          />
        </Center>
        <Text color="#2D2D2D99" mt="30">
