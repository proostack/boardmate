  ...
  return (
    <>
      ...
      <Input onChangeText={setUserName}
        ...
        InputRightElement={<Icon mr={"12px"} as={label === "Username" ? <AntDesign name="edit" size={24} color="white" onPress={setEditable} /> : label === "Password" ? <MaterialIcons onPress={setVisibility} name={visiblity ? 'visibility-off' : "visibility"} /> : null} />}
        variant={"unstyled"}
        fontFamily={"ReadexProBold"}
        value={input}
        editable={label == "Username" && true}
