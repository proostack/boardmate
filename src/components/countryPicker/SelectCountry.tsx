...
export default function SelectCountry({ getCountry, getCountryCode, bgColor, getPhoneNumber, phoneNumber }: ICountryProps): JSX.Element {
  ...
  return (
    <>
      ...
      <InputGroup w={{
        ...
        <Input value={phoneNumber} onChangeText={getPhoneNumber} borderRadius={12} keyboardType='number-pad' variant="unstyled" w={{
          base: "60%",
          md: "300"
